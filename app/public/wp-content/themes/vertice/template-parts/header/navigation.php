...
<div class="wp-block wp-block-kubio-navigation  position-relative wp-block-kubio-navigation__outer <?php echo $component->printNavigationClasses(); ?> vertice-header__k__tQxzUXOi9o-outer vertice-local-567-outer h-navigation_overlap" data-kubio="kubio/navigation" data-kubio-component="overlap" data-kubio-settings="true" id="navigation">
	<?php vertice_theme()->get( 'inner-top-bar' )->render(); ?>
	<div class="wp-block wp-block-kubio-navigation-section  position-relative wp-block-kubio-navigation-section__nav vertice-header__k__sNZ9xUM8ReR-nav vertice-local-584-nav h-section h-navigation" data-kubio="kubio/navigation-section" data-kubio-component="navigation" data-kubio-settings="{&quot;sticky&quot;:false,&quot;overlap&quot;:true}">
		<div class="position-relative wp-block-kubio-navigation-section__nav-section vertice-header__k__sNZ9xUM8ReR-nav-section vertice-local-584-nav-section    <?php echo $component->printContainerClasses(); ?>">
							...
							<div class="position-relative wp-block-kubio-column__inner vertice-header__k__6h2CZwR7i3G-inner vertice-local-587-inner d-flex h-flex-basis h-px-lg-0 v-inner-lg-0 h-px-md-2 v-inner-md-0 h-px-2 v-inner-2">
								<div class="position-relative wp-block-kubio-column__align vertice-header__k__6h2CZwR7i3G-align vertice-local-587-align h-y-container h-column__content h-column__v-align flex-basis-auto align-self-lg-center align-self-md-center align-self-center">
									...
									vertice_theme()->get( 'logo' )->render(
										array(
											'wrapper_class'    => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row vertice-header__k__4YrpoDz2gL0-container vertice-local--container',
											'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  vertice-header__k__4YrpoDz2gL0-image vertice-local--image',
											'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   vertice-header__k__4YrpoDz2gL0-alternateImage vertice-local--alternateImage',
											'logo_text_class'  => 'position-relative wp-block-kubio-logo__text  vertice-header__k__4YrpoDz2gL0-text vertice-local--text',
										)
									);
									?>
								</div>
