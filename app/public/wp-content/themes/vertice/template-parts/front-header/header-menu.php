...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer vertice-front-header__k__c6BbujDIAOY-outer vertice-local-115-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
	...
	<div class="wp-block wp-block-kubio-menu-offscreen  position-relative wp-block-kubio-menu-offscreen__container vertice-front-header__k__r1Ph182_RWJ-container vertice-local-117-container" data-kubio="kubio/menu-offscreen">
		<div class="position-relative wp-block-kubio-menu-offscreen__align vertice-front-header__k__r1Ph182_RWJ-align vertice-local-117-align">
			<button class="position-relative wp-block-kubio-menu-offscreen__iconWrapper vertice-front-header__k__r1Ph182_RWJ-iconWrapper vertice-local-117-iconWrapper kubio-offscreen-icon-wrapper" data-target="#kubio-offscreen-65488bd7a1d38" data-target-id="kubio-offscreen-65488bd7a1d38" data-direction="right" data-width="300px" data-offcanvas-overlay-id="kubio-offscreen-65488bd7a1d38-overlay" aria-label="<?php esc_attr_e( 'Mobile Menu', 'vertice' ); ?>" data-kubio-component="offcanvas" data-kubio-settings="[]">
									...
									<div class="position-relative wp-block-kubio-column__inner vertice-front-header__k__dySu33XviAE-inner vertice-local-120-inner d-flex h-flex-basis h-px-lg-2 v-inner-lg-2 h-px-md-2 v-inner-md-2 h-px-2 v-inner-2">
										...
										<div class="position-relative wp-block-kubio-column__align vertice-front-header__k__dySu33XviAE-align vertice-local-120-align h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
											...
											vertice_theme()->get( 'logo' )->render(
												array(
													'wrapper_class'        => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row vertice-front-header__k__afIZ7lcsb-container vertice-local--container',
													'logo_image_class'     => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  vertice-front-header__k__afIZ7lcsb-image vertice-local--image',
													'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   vertice-front-header__k__afIZ7lcsb-alternateImage vertice-local--alternateImage',
													'logo_text_class'      => 'position-relative wp-block-kubio-logo__text  vertice-front-header__k__afIZ7lcsb-text vertice-local--text',
												)
											);
											?>
										</div>
